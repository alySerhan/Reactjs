...
const services = [
  ...
  //   },
  {
    ...
    price: "10$",
    description:
      "Achieve smooth, hair-free skin with our professional waxing services. We offer gentle and effective waxing for various areas, ensuring a comfortable experience and long-lasting results",
  },
];
const Serthree = () => {
  ...
  return (
    <div className={`serone ${isVisible ? "fade-in" : ""}`}>
      <div className="services-title">
        ...
        <h1>Face Services</h1> <img src={right} alt="right" />
      </div>
